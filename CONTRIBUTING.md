...
Thanks for your interest in contributing to AI Catalog Go SDK! Here are a few
...
reported or fixed by searching through our [issues list](https://github.com/agntcy/ai-catalog-go-sdk/issues).
...
You can use the `-s` flag when you do a `git commit` to simplify including a properly
...
We welcome anyone that wants to contribute to AI Catalog Go SDK to triage and
...
- Review existing pull requests, and testing patches against real existing
  applications that use `ai-catalog-go-sdk`.
- Write a test, or add a missing test case to an existing test.

Thanks again for your interest on contributing to `ai-catalog-go-sdk`!
