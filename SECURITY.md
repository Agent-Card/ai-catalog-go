...
- <https://github.com/Agent-Card/ai-catalog-go/security/advisories/new>
...
- the affected package, component, or workflow
...
| --- | --- |
| `main` | Yes |
| latest published module version | Best effort when applicable |
| earlier module versions and feature branches | No |

## Scope

Security reports are especially relevant for:

- catalog parsing, identity binding, and JCS canonicalization
- digest parsing and verification in the `trust` package
- catalog validation and conformance-level detection
- remote catalog retrieval in the `provider` package
